...
<div class="w-full p-3">
    <div class="main-grid-carts">
        <div class="box-items">
            ...
            <p class="text-2xl font-extrabold text-slate-800">$236.18k</p>
            <p class="text-sm text-slate-500 mt-1">Total Product</p>
        </div>
        <div class="box-items">
            ...
            <p class="text-2xl font-extrabold text-slate-800">13,461</p>
        ...
        <div class="box-items">
            ...
            <p class="text-2xl font-extrabold text-slate-800">17,150</p>
        ...
        <div class="box-items">
            ...
            <p class="text-2xl font-extrabold text-slate-800">3,519</p>
...
<div class="m-3 mb-6 sm:px-6 shadow-lg rounded-md bg-white">
  <div class="header-main-tb">
    ...
    <div class="sm:mt-0 sm:flex-none bg">
      <button type="button" class="btn-showall">
        Show All</button>
    </div>
  </div>
...
<div class="m-3 mb-6 sm:px-6 shadow-lg rounded-md bg-white">
  ...
  <div class="mt-3 flow-root pb-2">
    <div class="tb-overflow">
      <div class="inline-block min-w-full pb-2 align-middle sm:px-2 pt-2">
        <table class="table-filter min-w-full divide-y divide-blue-300">
        {{-- th table --}}
      <thead class="bg-[#002398]">
        <tr>
          <th scope="col" class="table-header">Name</th>
