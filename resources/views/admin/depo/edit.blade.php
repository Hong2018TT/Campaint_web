...
<div class="shadow-lg rounded-md bg-white">
    ...
    <div class="mt-5 flow-root pb-2 px-3">
        <form id="#" name="#" calss="max-w-md mx-auto" action="{{ route('update_depo', $depo->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 sm:gap-2 md:gap-4">
                            <div class="box-form">
                                ...
                                <div class="form-outline">
                                    <input type="text" name="Name_EN" id="Name_EN" value="{{ old('Name_EN', $depo->Name_EN) }}" class="form-input" placeholder="Enter your name english" required>
                                </div>
                                @error('Name_EN')
                            ...
                            <div class="box-form">
                                ...
                                <div class="form-outline">
                                    <input type="text" name="Address_EN" id="Address_EN" value="{{ old('Address_EN', $depo->Address_EN) }}" class="form-input" placeholder="Enter your address english" required>
                                </div>
                                @error('Address_EN')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="box-form">
                                ...
                                <div class="form-outline">
                                    <input type="text" name="Address_KH" id="Address_KH" value="{{ old('Address_KH', $depo->Address_KH) }}" class="form-input" placeholder="Enter your address english" required>
                                </div>
                                @error('Address_KH')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                    ...
                    <legend class="text-sm rounded-xs font-bold text-white px-2 bg-green-700">Province:</legend>
                        <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 sm:gap-2 md:gap-4">
                            ...
                            <div class="box-form">
                                ...
                                <div class="form-outline">
                                    <input type="text" name="Name_KH" id="Name_KH" value="{{ old('Name_KH', $depo->Name_KH) }}" class="form-input" placeholder="Enter your depo name khmer" required>
                                </div>
                                @error('Name_KH')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                                    ...
                                    <select name="province_EN" id="province_EN" autocomplete="province_EN" aria-label="province_EN" class="form-select" required>
                                        ...
                                        @foreach ($provinces as $province)
                                            <option value="{{ $province->PROVINCE }}" 
                                                {{ (old('province_EN') ?? $depo->province_EN) == $province->PROVINCE ? 'selected' : '' }}>
                                                {{ $province->PROVINCE }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="box-form">
                                ...
                                <div class="grid grid-cols-1 focus-within:relative">
                                    <select name="province_KH" id="province_KH" autocomplete="province_KH" aria-label="province_KH" class="form-select" required>
                                        ...
                                        @foreach ($provinces as $province)
                                            <option value="{{ $province->PROVINCE_KH }}" 
                                                {{ (old('province_KH"') ?? $depo->province_KH) == $province->PROVINCE_KH ? 'selected' : '' }}>
                ...
                <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 sm:gap-2 md:gap-4 mt-3">
                    <div class="box-form">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="tel" name="Phone" id="Phone" value="{{ old('Phone', $depo->Phone ) }}" class="form-input" placeholder="Enter your phone number" maxlength="14" required>
                        </div>
                        @error('Phone')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="box-form">
                        ...
                        <div class="form-outline">
                            <input type="text" name="GPS" id="GPS" value="{{ old('GPS', $depo->GPS ) }}" class="form-input" placeholder="Enter your product name en" required>
                        </div>
                        @error('GPS')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
